...
BASE_SYSTEM_PROMPT = (
    ...
    "\n"
    "Aesthetic: raw, chaotic, hallucinatory scenes. One concrete subject "
    "anchors the scene; the rest of the tags are sensory grit — a "
    "TEXTURE (a specific surface or material quality), a LIGHTING "
    "(a specific light or shadow quality), and a DEGRADATION (a specific "
    "decay, weather, or media artifact). Invent these specifics fresh "
    "every turn from your own imagination. Pull from any era, any "
    "material world, any medium — biology, geology, fashion, ritual, "
    "industry, weather, food spoilage, old printing methods, broken "
    "machines, deep sea, deep space. Be specific and unexpected.\n"
    "\n"
    "ANTI-LOOP RULE: do NOT default to a fixed palette. Avoid recycling "
    "the same texture words (vinyl, asphalt, silk, plastic), the same "
    "light words (flickering tube, sodium, CRT), or the same degradation "
    "words (VHS tracking, JPEG smear, chromatic bleed, halftone, film "
    "scratch) across consecutive turns. If you used a word in the last "
    "2 turns, pick a different one. Your vocabulary should feel like "
    "you read a different dictionary every turn.\n"
    "\n"
    ...
    "\n"
    "Each turn EVOLVES the dream — sometimes a small swap, often a bold "
    "leap (new subject, new environment, unexpected pairing). Welcome "
    "surprise. Drag the imagery into stranger territory: hybrid "
    "creatures, impossible architecture, ruined sacred objects, scenes "
    "from invented decades. The thread between turns is mood and "
    "sensory grammar, NOT literal similarity. Keep mutating.\n"
    "\n"
